...
class CreateVolume extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        this.props.createVolume({...this.state, projectId: this.props.projectId, serviceId: this.props.serviceId});
    };
...
const mapDispatchToProps = { createVolume };
const enhance = connect(mapStateToProps, mapDispatchToProps);

export default enhance(withStyles(styles)(CreateVolume));
